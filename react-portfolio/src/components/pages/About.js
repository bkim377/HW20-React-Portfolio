            ...
            <div className="row">
                ...
                <div className="row p-3">
                  <div className="col-sm-8">
                    <img src = "./assets/imgs/BrandonKim.png" alt="Profile Picture"></img>
                    <h3>About Me</h3>
                    ...
                    <img className="social-media" src="./assets/imgs/github.png" alt="GitHub"></img>
                    <a href="https://github.com/bkim377">GitHub</a>
                    <p></p>
                    <img className="social-media" src="./assets/imgs/linkedin.png" alt="LinkedIn"></img>
                    <a href="https://www.linkedin.com/in/brandongkim/">LinkedIn</a>
                    <p></p>
                    <img className="social-media" src="./assets/imgs/resume.png" alt="Resume"></img>
